...
//  Smiling
//
//  Created by Sanjay Nighojkar on 4/16/17.
    ...
    func detectFace() {
        ...
        if (myImageView.image != nil) {
            ...
            if let face = faces?.first as? CIFaceFeature {
                ...
                let alert = UIAlertController(title: "No One Detected", message: "No one is smiling in this picture!", preferredStyle: UIAlertControllerStyle.alert)
